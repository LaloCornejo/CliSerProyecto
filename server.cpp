...
void printScoreboard() {
    ...
    ss << "\nPuntaggi Tecnologia (Ordinati Decrescente):\n";
    ...
    for (const auto &player_pair : sortedPlayersTech) {
        const auto &player = player_pair.second;
        ss << "-> " << player.nickname << ": " << player.techScore << "\n";
    }

    ss << "\nPuntaggi Cultura Generale (Ordinati Decrescente):\n";
    ...
    for (const auto &player_pair : sortedPlayersGeneral) {
        const auto &player = player_pair.second;
        ss << "-> " << player.nickname << ": " << player.generalScore << "\n";
    }
    ...
    try {
        ...
        scoreboard << "\nScoreboard:\nTechnology Quiz:\n";
        {
            ...
            for (const auto &player : players) {
                scoreboard << player.second.nickname << ": " << player.second.techScore << "\n";
            }
        }
        scoreboard << "General Knowledge Quiz:\n";
        {
            std::lock_guard<std::mutex> lock(playersMutex);
            for (const auto &player : players) {
                scoreboard << player.second.nickname << ": " << player.second.generalScore << "\n";
            }
        }
